...
def load_data():
    ...
    df_lat = pd.read_csv(
        'https://github.com/evmpython/web_app/raw/main/lat.csv', compression='zip')
    df_lon = pd.read_csv(
        'https://github.com/evmpython/web_app/raw/main/lon.csv', compression='zip')
    df_municipios = pd.read_csv(
        'https://github.com/evmpython/web_app/raw/main/municipios.csv', compression='zip')
    df_estados = pd.read_csv(
        'https://github.com/evmpython/web_app/raw/main/estados.csv', compression='zip')
    df_biomas = pd.read_csv(
        'https://github.com/evmpython/web_app/raw/main/biomas.csv', compression='zip')
